...
// function displayUnallocatedProcessRow(processSize, allocation) {
//     const unallocatedRow = document.getElementById('unallocated-row');
//     unallocatedRow.innerHTML = '';

//     for (let i = 0; i < processSize.length; i++) {
//         if (allocation[i] === -1) {
//             const processDiv = document.createElement('div');
//             processDiv.classList.add('process-bar');
//             processDiv.classList.add('unallocated-bar');
//             processDiv.innerHTML = `<div class="text">${processSize[i]} KB</div>`;
//             processDiv.style.width = `${processSize[i]}px`;
//             unallocatedRow.appendChild(processDiv);
//         }
//     }
// }
